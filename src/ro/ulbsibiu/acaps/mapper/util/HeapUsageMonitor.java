 ...
 * <p>
 * <code>
 * HeapUsageMonitor monitor = new HeapUsageMonitor(1024, 768);<br />
 * monitor.start();<br />
 ...
 * 
 */
public class HeapUsageMonitor extends JPanel {
	 ...
	 */
	public HeapUsageMonitor(int width, int height) {
		this.width = width;
		this.height = height;
	...
	public static void main(String[] args) {
		final HeapUsageMonitor heapUsageMonitor = new HeapUsageMonitor(1024,
				768);
