...
echo "This script uses the LAVA job scheduler to run a program multiple times, on computenode-000 and computenode-001."
...
do
	...
	bsub -o job-%J.out.log -e job-%J.err.log -J $1-$i -m "computenode-000 computenode-001" $JOB_ARGS -s $i	
done
